...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb_project", type=str, default="MiniMind-gated_PPO", help="wandb项目名")
    ...
    if args.use_wandb and is_main_process():
        ...
        wandb_run_name = f"MiniMind-gated_PPO-Epoch-{args.epochs}-BS-{args.batch_size}-LR-{args.learning_rate}"
