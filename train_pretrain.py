...
if __name__ == "__main__":
    ...
    parser.add_argument("--project_name", type=str, default="MiniMind-Pretrain")
    ...
    args.run_name = f"MiniMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
